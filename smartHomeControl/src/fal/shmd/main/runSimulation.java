...
public class runSimulation {
	...
	public static void main(String[] args) {
		...
		try {
			controllerBoxManager.initControllerBox("sampleFiles/halconfig.xml", "sampleFiles/controllerBoxConfig.xml");
		...
		try {
			myEngine.loadSingleScreenplay("sampleFiles/screenplay.xml");
		} catch (SimulationEngineException e) {
			e.printStackTrace();
			return;
		}
