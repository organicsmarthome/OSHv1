...
package fal.smartHomeLib.HAL.driver;
...
/**
 * dummy class for washing machines
 * @author florian
 *
 */
public class WaMaDriver extends HALdriver {

	public WaMaDriver(HALrealTimeDriver timerDriver, UUID deviceID,
			CBParameterCollection driverConfig) {
		super(timerDriver, deviceID, driverConfig);
		// TODO Auto-generated constructor stub
	}

	public WaMaDriver(UUID deviceID, HALrealTimeDriver timerDriver,
