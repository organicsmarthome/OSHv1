...
/**
 *
 * This class is not relevant for simulation issues
 * It will be used in the "real" smart-home for dispatching the communication between the Wago fieldbus and the drivers
 *
 *@author florian.allerding@kit.edu
 *@category smart-home ControllerBox HAL
 */
public class HALDispatcher extends CBGlobal implements ControllerBoxLifeCycle {

	public HALDispatcher(CBGlobalLogger logger){
