...
/**
 * <p>Java class for ObservedSmartPlugAction complex type.
 * 
 ...
 *         &lt;element name="changedPowerValue" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         &lt;element name="currentPowerValue" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ObservedSmartPlugAction", propOrder = {
    "startRunning",
    "stopRunning",
    "changedPowerValue",
    "currentPowerValue"
})
public class ObservedSmartPlugAction
    extends ObservedAction
{

    protected boolean startRunning;
    protected boolean stopRunning;
    protected boolean changedPowerValue;
    ...
    /**
     * Gets the value of the changedPowerValue property.
     * 
     */
    public boolean isChangedPowerValue() {
        return changedPowerValue;
    }

    /**
     * Sets the value of the changedPowerValue property.
     * 
     */
    public void setChangedPowerValue(boolean value) {
        this.changedPowerValue = value;
    }

    /**
     * Gets the value of the currentPowerValue property.
     * 
     */
    ...
    /**
     * Sets the value of the currentPowerValue property.
     * 
     */
    public void setCurrentPowerValue(int value) {
